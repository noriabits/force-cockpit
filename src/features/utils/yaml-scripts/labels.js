...
window.YamlScriptsLabels = {
  ...
  labelAiPrompt: 'Analysis prompt',
  labelModel: 'Model',
  modelPlaceholder: 'Select a model…',
  modelHintNone: 'No language models available — enable GitHub Copilot in VS Code.',
  errorModelRequired: 'Please select a model.',
  labelGather: 'Gather data first (optional)',
  gatherTypeSoql: 'SOQL',
  gatherTypeApex: 'Apex (inline)',
  gatherTypeApexFile: 'Apex file',
  placeholderGatherSoql: 'SELECT Id, Name FROM Account WHERE Industry = ${industry}',
  placeholderGatherApex: 'System.debug(JSON.serialize([SELECT Id, Name FROM Account LIMIT 50]));',
  labelGatherFilePath: 'Apex file path',
  labelAllowFollowup: 'Allow follow-up SOQL queries',
  labelAllowReadFiles: 'Allow searching & reading workspace files (Apex, metadata, etc.)',
  labelSkills: 'Skills',
